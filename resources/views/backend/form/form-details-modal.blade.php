                ...
                <h5 class="fs-15">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            @else
                                <td><a href="{{ asset('form/'.$datas->military_service_certificate) }}" download target="_blank" class="btn btn-danger btn-sm">İndir</a></td>
                            @endif
                        </tr>
                        <tr>
                            ...
                            @if($datas->identity == '')
                                <td class="text-danger"> Dosya Yüklenmemiş</td>
                            @else
                                <td><a href="{{ asset('form/'.$datas->identity) }}" download target="_blank" class="btn btn-danger btn-sm">İndir</a></td>
                            @endif
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            @if($datas->certificate == '')
                                <td class="text-danger"> Dosya Yüklenmemiş</td>
                            @else
                                <td><a href="{{ asset('form/'.$datas->certificate) }}" download target="_blank" class="btn btn-danger btn-sm">İndir</a></td>
                            @endif
                        </tr>
                        <tr>
                            ...
                            @if($datas->transcript == '')
                                <td class="text-danger"> Dosya Yüklenmemiş</td>
                            @else
                                <td><a href="{{ asset('form/'.$datas->transcript) }}" download target="_blank" class="btn btn-danger btn-sm">İndir</a></td>
                            @endif
                        </tr>
                        <tr>
                            <td class="text-danger"> Ales</td>
                            <td>{{ $datas -> ales == '' ? 'Deger Girilmemiş': $datas -> ales }}</td>>
                        </tr>
                        <tr>
                            <td class="text-danger">Diploma</td>
                            @if($datas->ales_certificate == '')
                                <td class="text-danger"> Dosya Yüklenmemiş</td>
                            @else
                                <td><a href="{{ asset('form/'.$datas->ales_certificate) }}" download target="_blank" class="btn btn-danger btn-sm">İndir</a></td>
                            @endif
                        </tr>
                        <tr>
                            <td class="text-danger"> Yds</td>
                            <td>{{ $datas -> yds == '' ? 'Deger Girilmemiş': $datas -> yds }}</td>
                        </tr>
                        <tr>
                            <td class="text-danger">Diploma</td>
                            @if($datas->yds_certificate == '')
                                <td class="text-danger"> Dosya Yüklenmemiş</td>
                            @else
                                <td><a href="{{ asset('form/'.$datas->yds_certificate) }}" download target="_blank" class="btn btn-danger btn-sm">İndir</a></td>
                            @endif
                        </tr>
                        </tbody>
                    </table>
